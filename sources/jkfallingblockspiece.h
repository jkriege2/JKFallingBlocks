...
class JKFallingBlocksPiece
{
    public:
        ...
        explicit JKFallingBlocksPiece(int* board=NULL, int boardWidth=0, int boardHeight=0);
        ~JKFallingBlocksPiece();
        ...
        bool init(const JKFallingBlocksPiece& other);
